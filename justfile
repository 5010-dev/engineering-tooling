...
package-check source_commit:
    ...
    cp standards/snapshots/2026.08.4/manifest.json dist/standard-snapshot-manifest.json; \
    ...
    cp release/source-integrity-2026-08-09.json dist/source-integrity.json; \
    cp release/tooling-cutoff-2026-08-04.json dist/tooling-cutoff.json; \
    cp generator/schemas/*.json dist/; \
    cp standards/snapshots/2026.08.4/schemas/golden-path-dependency-*.schema.json dist/; \
