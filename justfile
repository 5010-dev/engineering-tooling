...
package-check source_commit:
    ...
    cp standards/snapshots/2026.08.2/manifest.json dist/standard-snapshot-manifest.json; \
    ...
    cp release/source-integrity-2026-08-07.json dist/source-integrity.json; \
