...
func run(arguments []string, stderr io.Writer) error {
	...
	snapshotFile, snapshotData, err := matchingEvidence(root, distRoot, "standards/snapshots/2026.08.6/manifest.json", "standard-snapshot-manifest.json")
	if err != nil {
	...
	document := manifest{
		...
		SchemaVersions: []string{
			...
			"golden-path-dependency-observation/v2",
			"golden-path-dependency-candidate/v1",
			"golden-path-dependency-report/v1",
			"golden-path-dependency-report/v2",
...
func collectSchemaEvidence(sourceRoot, distRoot *os.Root) ([]schemaEvidence, error) {
	assets := []schemaAsset{
		...
		{ID: "golden-path-dependency-candidate/v1", SourceName: "standards/snapshots/2026.08.6/schemas/golden-path-dependency-candidate-v1.schema.json", DistName: "golden-path-dependency-candidate-v1.schema.json"},
		{ID: "golden-path-dependency-defers/v1", SourceName: "standards/snapshots/2026.08.6/schemas/golden-path-dependency-defers-v1.schema.json", DistName: "golden-path-dependency-defers-v1.schema.json"},
		{ID: "golden-path-dependency-observation/v1", SourceName: "standards/snapshots/2026.08.6/schemas/golden-path-dependency-observation-v1.schema.json", DistName: "golden-path-dependency-observation-v1.schema.json"},
		{ID: "golden-path-dependency-observation/v2", SourceName: "standards/snapshots/2026.08.6/schemas/golden-path-dependency-observation-v2.schema.json", DistName: "golden-path-dependency-observation-v2.schema.json"},
		{ID: "golden-path-dependency-policy/v1", SourceName: "standards/snapshots/2026.08.6/schemas/golden-path-dependency-policy-v1.schema.json", DistName: "golden-path-dependency-policy-v1.schema.json"},
		{ID: "golden-path-dependency-report/v1", SourceName: "standards/snapshots/2026.08.6/schemas/golden-path-dependency-report-v1.schema.json", DistName: "golden-path-dependency-report-v1.schema.json"},
		{ID: "golden-path-dependency-report/v2", SourceName: "standards/snapshots/2026.08.6/schemas/golden-path-dependency-report-v2.schema.json", DistName: "golden-path-dependency-report-v2.schema.json"},
