...
func Render(request Request, release ReleaseManifest) ([]File, string, error) {
	...
	if mode == "bootstrap" {
		...
		commonTemplates = append(commonTemplates,
			...
			templateAsset{".github/CODEOWNERS", "common/.github/CODEOWNERS.tmpl", 0o644, nil},
			templateAsset{".github/dependabot.yml", "common/.github/dependabot.yml.tmpl", 0o644, dependabot},
			templateAsset{".github/golden-path-dependency-policy.yaml", "common/.github/golden-path-dependency-policy.yaml.tmpl", 0o644, nil},
